...
if 'lr_data' in st.session_state:
    ...
    def get_receipt_html(copy_title):
        ...
        # Built-in High-Resolution Vector Logo (No Image file needed)
        custom_logo_svg = """
        <svg width="45" height="42" viewBox="0 0 100 80" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="50%" y="72%" dominant-baseline="middle" text-anchor="middle" fill="#FFF" font-size="10" font-weight="bold" font-family="Arial">LOGISTICS</text>
        </svg>
        """

        return f"""
        <div style="position: relative; margin-bottom: 6px;">
            <div class="copy-box" style="border: 2px solid #000; padding: 6px; background: #fff; font-family: Arial, sans-serif; font-size: 10.5px; box-sizing: border-box; height: 31vh; display: flex; flex-direction: column; justify-content: space-between;">
                <div>
                        ...
                        <tr>
                            <td style="width: 44%; vertical-align: top;">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    {custom_logo_svg}
                                    <div>
                                        <h2 style="margin: 0; font-size: 19px; font-weight: 900; letter-spacing: 0.5px; line-height: 1; font-family: 'Arial Black', Impact, sans-serif;">FORTUNE EXPRESS CARGO</h2>
                                        <i style="font-size: 9.5px;">Always on Time</i>
                                    </div>
                                </div>
            ...
            <div style="border-bottom: 1.5px dashed #000; margin-top: 3px; text-align: right; font-size: 9px;">✂️ CUT HERE -----------------------------------------------------------------------------------------------------------------------------</div>
        </div>
        """
    ...
    <body style="margin:0; padding:0; background:#fff;">
        <div style="text-align: center; margin-bottom: 8px;" class="print-btn">
            <button onclick="window.print()" style="background-color: #007bff; color: white; padding: 12px 24px; border: none; font-size: 16px; font-weight: bold; border-radius: 5px; cursor: pointer;">
                🖨️ PRINT ALL 3 COPIES (PERFECT FIT WITH LOGO & PERFORATION)
            </button>
        </div>
        <div>
