...
with st.form("lr_form"):
    ...
    with col4:
        ...
        if "CGST" in gst_type:
            ...
            sgst = round(grand_total - total_freight - cgst, 2)
            igst = 0.0
        else:
            total_freight = round(grand_total / 1.18, 2)
            cgst = 0.0
        ...
        st.info(f"✨ Auto Calculated -> Basic Freight: {basic_freight} | GST Adjusted.")
...
if 'lr_data' in st.session_state:
    ...
    def get_receipt_html(copy_title):
        ...
        return f"""
        <div class="copy-box" style="border: 1.5px solid #000; padding: 2px 4px; background: #fff; font-family: Arial, sans-serif; box-sizing: border-box; height: 31vh; display: flex; flex-direction: column; justify-content: space-between; margin-bottom: 2mm;">
            <div>
                <div style="background: #000; color: #fff; text-align: center; font-weight: bold; font-size: 10px; padding: 1px 0;">
                    ...
                    <tr>
                        <td style="width: 50%; vertical-align: top;">
                            <div style="display: flex; align-items: center; gap: 6px;">
                                <svg width="45" height="22" viewBox="0 0 60 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 19px; font-weight: 900; font-family: 'Georgia', 'Times New Roman', serif; letter-spacing: 0.5px; line-height: 1.1; white-space: nowrap;">
                                        <span style="color: #d32f2f;">FORTUNE</span> <span style="color: #000;">EXPRESS CARGO</span>
                                    </div>
                                </div>
                            </div>
                            <div style="font-size: 10px; line-height: 1.1; margin-top: 1px;">
                        ...
                        <td style="width: 25%; vertical-align: top; text-align: center;">
                            <div style="font-size: 10px; line-height: 1.15; text-align: left; display: inline-block;">
                                <b>PAN No. :</b> AGVPM3701F<br>
                                <b>GST No. :</b> 24AGVPM3701F2ZF<br>
                                <b>SAC No. :</b> 9965
                            </div>
                            <div style="margin-top: 1px;">
                                <span style="border: 1px solid #000; padding: 1px 5px; border-radius: 4px; font-weight: bold; font-size: 10px; background: #fff; display: inline-block;">
                                    {copy_title}
                                </span>
                            </div>
                        </td>
                        <td style="width: 25%; vertical-align: top; text-align: center;">
                            <div style="border: 1px solid #000; padding: 1px;">
                                <div style="font-size: 9px; font-weight: bold; color: #333;">DOCKET NUMBER</div>
                            ...
                            <table style="width: 100%; border: 1px solid #000; margin-top: 1px; font-size: 10px; text-align: left; border-collapse: collapse;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 1px; border: 1px solid #000; font-size: 10.5px;">
                    <tr>
                        <td style="width: 50%; border: 1px solid #000; padding: 2px 4px; vertical-align: top; line-height: 1.2;">
                            <b style="font-size: 10px;">CONSIGNOR DETAILS (PLACE OF SUPPLY)</b><br>
                            <b>NAME :</b> {d['consignor']}<br>
                            <b>GST NO. :</b> {d['consignor_gst']} &nbsp;&nbsp;|&nbsp;&nbsp; <b>CONTACT :</b> {d['consignor_contact']}
                        </td>
                        <td style="width: 50%; border: 1px solid #000; padding: 2px 4px; vertical-align: top; line-height: 1.2;">
                            <b style="font-size: 10px;">CONSIGNEE DETAILS (DELIVERY DESTINATION)</b><br>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 1px; border: 1px solid #000; font-size: 10px; text-align: center;">
                    <tr style="font-weight: bold; background: #f2f2f2;">
                        ...
                        <td style="border: 1px solid #000; width: 8%; font-size: 8.5px;">Monthly Billing</td>
                        <td style="border: 1px solid #000; width: 8%; font-size: 8.5px;">PAID</td>
                        <td style="border: 1px solid #000; width: 8%; font-size: 8.5px;">TO PAY</td>
                    </tr>
                    <tr>
                        ...
                        <td style="border: 1px solid #000; vertical-align: middle; text-align: center; font-size: 18px; color: #008000; font-weight: 900;" rowspan="11">{billing_mark}</td>
                        <td style="border: 1px solid #000; vertical-align: middle; text-align: center; font-size: 18px; color: #008000; font-weight: 900;" rowspan="11">{paid_mark}</td>
                        <td style="border: 1px solid #000; vertical-align: middle; text-align: center; font-size: 18px; color: #008000; font-weight: 900;" rowspan="11">{topay_mark}</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #000; padding: 2px 4px; text-align: left;" colspan="3" rowspan="10" vertical-align="top">
                ...
                <div style="border: 1px solid #000; margin-top: 1px; padding: 1px 4px; font-size: 10px;">
                    <b>INVOICE NO. & VALUE | WEIGHT DETAILS :-</b> {d['inv_no_val_wt']}
                </div>

                <div style="font-size: 7.5px; margin-top: 1px; text-align: justify; line-height: 1.05; color: #000; font-weight: 600;">
            ...
            <div style="font-size: 8.5px; border-top: 1px solid #000; padding-top: 1px; margin-top: 1px; line-height: 1.1; font-weight: bold; text-align: justify;">
